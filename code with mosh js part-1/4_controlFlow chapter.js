...
greet(0);
function greet(hour) {
  if (6 <= hour && hour < 12) console.log('Good morning');
  else if (12 <= hour && hour < 18) console.log('Good afternoon');
  else if (18 <= hour && hour < 24) console.log('Good night');
...
let newText = document.createTextNode(
  "This is the new p element with class 'p'."
);
