...
const countOccurance2 = (array, searchElement) => {
    return array.reduce((accumlator, curValue) => (curValue === searchElement) ? ++accumlator : accumlator,0);
}
...
const movieSelector = array => {
    let output = [...movies];
    output = output.filter(obj => (obj.year === 2018 && obj.rating >=4))
