...
function sum (...args) {
    ...
    (invalidInput!==0) ? console.log('invalid input(s) found:', invalidInput) : null;
}
...
const sum2 = (...arg) => {
    ...
    const invalidInput = arg.filter(elements => typeof elements !== 'number' && !Array.isArray(elements)).length;
